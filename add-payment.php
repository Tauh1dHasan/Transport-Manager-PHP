...
if (empty($_GET['id'])) {
    ...
    if (isset($_POST['save'])) {
        ...
        $payment = mysqli_escape_string($con, $_POST['payment']);
        ...
        // new balance
        $new_blnce = $curr_blnce_amount + $payment;

        $run_sql = mysqli_query($con, "INSERT INTO due_payment (customer_id, action_date, payment, balance) VALUES ('$customer_id', '$action_date', '$payment', '$new_blnce')");
                            ...
                            <form action="#" method="post" class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label>Amount</label>
                                        <input name="payment" type="number" class="form-control" placeholder="Amount of money" required>
                                    </div>
